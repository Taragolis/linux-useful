...
#   sudo sh -c "$(wget https://raw.githubusercontent.com/Taragolis/linux-useful/master/add-user/debian-user.sh -qO -)"
# or
#   sudo sh -c "$(curl -fsSL https://raw.githubusercontent.com/Taragolis/linux-useful/master/add-user/debian-user.sh)"
